...
-- 1-2 修改：用 Email 找到 李燕容、肌肉棒子、Q太郎，如果他的 Role 為 USER 將他的 Role 改為 COACH
        update "USER" 
        set "role" = 'COACH'
        where "email" ='lee2000@hexschooltest.io' and "role" = 'USER';

        update "USER" 
        set "role" = 'COACH'
        where "email" ='muscle@hexschooltest.io' and "role" = 'USER';

        update "USER" 
        set "role" = 'COACH'
        where "email" ='starplatinum@hexschooltest.io' and "role" = 'USER';
